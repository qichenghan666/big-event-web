...
//文章列表查询
import { articleCategoryListService,articleAddService,articleUpdateService } from "@/api/article.js";
...
//文章列表查询
import { articleListService,articleDeleteService } from "@/api/article.js";
  ...
  <el-card class="page-container">
    <template #header>
      <div class="header">
        <span>文章管理</span>
        <div class="extra">
          <el-button type="primary" @click="visibleDrawer = true;title='添加文章'"
            >添加文章</el-button
          >
        </div>
      </div>
    ...
    <el-table :data="articles" style="width: 100%">
      ...
      <el-table-column label="操作" width="100">
        <template #default="{ row }">
          <el-button :icon="Edit" circle plain type="primary" @click="title='修改文章';visibleDrawer=true;updateArticleEcho(row)"></el-button>
